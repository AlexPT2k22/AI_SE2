...
# URL da ESP32-CAM
ESP32_URL = "http://10.254.177.15/stream"

print(f"A tentar conectar à ESP32-CAM: {ESP32_URL}")
cap = cv2.VideoCapture(ESP32_URL)

if not cap.isOpened():
    print("❌ Erro: Não consegui conectar à ESP32-CAM!")
    print("Verifica se:")
    print("  1. A ESP32-CAM está ligada")
    print("  2. O IP está correto (10.254.177.15)")
    print("  3. Consegues abrir http://10.254.177.15 no browser")
    sys.exit(1)
