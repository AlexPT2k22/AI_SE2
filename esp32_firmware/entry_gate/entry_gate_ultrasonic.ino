...
#define LED_GREEN_PIN 14    // LED verde (autorizado)
#define LED_RED_PIN 15      // LED vermelho (negado)
...
void setup() {
  Serial.begin(115200);
  Serial.println("\n\n=== ESP32-CAM OV3660 - Sensor Ultrassônico ===");
  ...
  servoBarreira.write(0);  // Posição inicial: fechado
  Serial.println("Servo inicializado em posição fechada (0°)");
